...
public class CityMap
{
  ...
  // CityMap keeps its original functionality and adds new functionality. The
  // city map is now divided into 4 zones: zone 0, 1, 2, 3. Zone 0 extends from 1st
  // avenue to 5th avenue and 6th to 9th street. Zone 1 extends from 6th avenue to 9th
  // avenue and 6th to 9th street. Zone 2 extends from 6th avenue to 9th avenue and 1st
  // to 5th street. Zone 3 extends from 1st avenue to 5th avenue and 1st to 5th street.
  /**
  ...
  public static int getCityZone(String address) {
    ...
    // Zone 0: 1st to 5th Avenue, 6th to 9th Street
    if (avenue >= 1 && avenue <= 5 && street >= 6 && street <= 9) {
        return 0;
    }
    // Zone 1: 6th to 9th Avenue, 6th to 9th Street
    else if (avenue >= 6 && avenue <= 9 && street >= 6 && street <= 9) {
        return 1;
    }
    // Zone 2: 6th to 9th Avenue, 1st to 5th Street
    else if (avenue >= 6 && avenue <= 9 && street >= 1 && street <= 5) {
        return 2;
    }
    // Zone 3: 1st to 5th Avenue, 1st to 5th Street
    else if (avenue >= 1 && avenue <= 5 && street >= 1 && street <= 5) {
        return 3;
    }
    return -1; // In case the address does not fall into any of the zones
  }
